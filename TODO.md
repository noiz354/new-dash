...
- [ ] BACKEND-ONLY → putuskan expose atau kunci: inspections CRUD + force-dispatch, wo tasks, parts/movements, purchasing/grn, ~~queue/jobs~~ (EXPOSED+honest — GAP-16 TASK 3 CLOSED 2026-09-16), retention/digest, reports/aggregates, telemetry ingest/metrics, billing UI, ~~signup form~~ (signup form EXPOSED — GAP-16 TASK 1 CLOSED 2026-09-16)
...
- [ ] GAP-16: 7 keputusan produk (F2/F12/F23/F25/F15/F26/F27) — **TASK 1–3/7 DONE 2026-09-16: F2 signup UI; F12 refs TRF-/ADJ- dihapus; F23 jobs page jujur + wire queue nyata (preseed dihapus, retry 404, banner ephemeral)**; sisa: F25 deprecate digest / F15 facilities backend / F26 settings KV / F27 handover backend
