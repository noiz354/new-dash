...
- [ ] BACKEND-ONLY → putuskan expose atau kunci: inspections CRUD + force-dispatch, wo tasks, parts/movements, purchasing/grn, queue/jobs, retention/digest, reports/aggregates, telemetry ingest/metrics, billing UI, ~~signup form~~ (signup form EXPOSED — GAP-16 TASK 1 CLOSED 2026-09-16)
...
- [ ] GAP-16: 7 keputusan produk (F2/F12/F23/F25/F15/F26/F27) — **TASK 1/7 DONE 2026-09-16: F2 signup UI dibangun** (`app/(auth)/signup/page.tsx` + `SignupForm.tsx`, proxy +`/signup`, 3 test, runtime :3157); sisa: F12 hapus refs / F23 jobs jujur+wire / F25 deprecate digest / F15 facilities backend / F26 settings KV / F27 handover backend
