...
- [ ] FRONTEND-ONLY → wire atau label jujur: reports hub, PM hub, shifts plan, ~~facilities hub~~ (backend+wire — GAP-16 TASK 5 CLOSED 2026-09-16), vendors flows, ~~settings hub~~ (KV backend+wire — GAP-16 TASK 6 CLOSED 2026-09-16), jobs page (SEED), print templates (WO/PO/badge/permit: nyatakan sumber CANON)
...
- [ ] GAP-16: 7 keputusan produk (F2/F12/F23/F25/F15/F26/F27) — **TASK 1–5/7 DONE 2026-09-16: F2 signup UI; F12 refs TRF-/ADJ- dihapus; F23 jobs jujur+wire queue; F25 retention digest deprecated eksplisit (sunset 2026-12-15); F15 facilities backend+wire (FASE-1 honest copy+FASE-2 tabel/service/route)**; sisa: F26 settings KV / F27 handover backend
