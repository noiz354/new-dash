...
- [ ] FRONTEND-ONLY → wire atau label jujur: reports hub, PM hub, shifts plan, ~~facilities hub~~ (backend+wire — GAP-16 TASK 5 CLOSED 2026-09-16), vendors flows, settings hub, jobs page (SEED), print templates (WO/PO/badge/permit: nyatakan sumber CANON)
